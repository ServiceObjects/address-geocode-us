import { GetDistanceToWaterSoap } from "../address-geocode-us-nodejs/SOAP/get_distance_to_water_soap.js";

async function GetDistanceToWaterSoapGo(licenseKey, isLive) {
    console.log("\n--------------------------------------------------");
    console.log("Address Geocode US - GetDistanceToWater - SOAP SDK");
    console.log("--------------------------------------------------");
...
export { GetDistanceToWaterSoapGo };