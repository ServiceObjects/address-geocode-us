...
class GetReverseLocationSoap:
    def __init__(self, latitude: str, longitude: str, license_key: str, is_live: bool = True, timeout_ms: int = 15000):
        """
        Initialize the GetReverseLocationSoap client with input parameters and set up primary and backup WSDL URLs.
    ...
    def get_reverse_location(self) -> Object:
        """
        Calls the GetReverseLocation SOAP endpoint, attempting the primary endpoint first and falling back
        to the backup if the response is invalid (Error.TypeCode == '4') in live mode or if the primary call fails.

        Returns:
            suds.sudsobject.Object: SOAP response containing address details or error.
        ...
        try:
            ...
            response = client.service.GetReverseLocation(**call_kwargs)
